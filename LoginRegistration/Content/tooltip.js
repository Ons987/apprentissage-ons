    ...
    var Qb = function (a) {
        ...
        dc = function (r, j, q) {
            ...
            if (q == 1) {
                ...
                /*c[R]=j*/
                $('.mcTooltipWrapper').css('display', 'none!important');
                tooltipReminder = 1;
                var g = 1
            } else {
                tooltipReminder = 2;
                $('.mcTooltipWrapper').css('display', 'block!important');
                var d = t(W, j);
                if (d[C].w) c = d[C];
                else {
                    c.w = d[C];
        ...
        Vb = function () {
            if (document.styleSheets && document.styleSheets.length) {
                ...
                c.insertRule(d, 0);
                var e = "#tooltipAjaxSpin {margin:30px;font-size:0;width:20px;height:20px;" + a + "animation:mcttSpinner .6s linear infinite;}";
                c.insertRule(e, 0)
            }
        },
        s = null,
